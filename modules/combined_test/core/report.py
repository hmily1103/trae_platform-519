...
def save_report(pipeline_id: str, pipeline_type: str, result: dict, logs: list, config: dict) -> str:
    ...
    report_data = {
        ...
        'precision_analysis_id': config.get('precision_analysis_id') or '',
        'precision_test_point_id': config.get('precision_test_point_id') or '',
        'precision_execution_id': config.get('precision_execution_id') or '',
        'config': {
